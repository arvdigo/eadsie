...
//Geração do número de inscrição para o processo seletivo de EAD
//ANTES: $numinscricao = substr($cpf, 0,2).$id;
$edital= $_SESSION["Gedital"];
$ano   = $_SESSION["Gano"];
$numinscricao = $edital.$ano.substr($cpf, 0,4).$id;
...
//Alterado - Devido ao Processo Seletivo de EAD - Local da prova será colocado como o próprio campus
$inscrito->setlocalprova($campus);
